...
const sections = [
  ...
  {
    title: "Section 2 �-s-f-b-e-    body: "This website is intended for informational purposes about AL-JADRIYA Engineering's services. You agree not to misuse the website, attempt unauthorized access, or use its content for commercial purposes without written permission.",
  },
  {
