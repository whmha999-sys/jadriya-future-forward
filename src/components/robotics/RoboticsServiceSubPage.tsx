...
import RoboticsNavbar from "./RoboticsNavbar";
...
interface RoboticsServiceSubPageProps {
  heroImage: string;
  ...
  return (
    <div className="min-h-screen" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <section className="bg-card py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-8 md:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="section-label text-accent mb-4">{t("robo.whatWeOffer")}</p>
      ...
      <section className="bg-[hsl(var(--navy-deep))] py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-8 md:px-16">
          <p className="section-label text-accent mb-4">{t("robo.keyFeatures")}</p>
...
export default RoboticsServiceSubPage;
