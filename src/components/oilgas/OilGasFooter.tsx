    ...
    <footer className="bg-[hsl(var(--slate-dark))]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <img src={ogLogo} alt="AL-JADRIYA" className="h-10 w-10 brightness-0 invert" />
              <div>
            ...
            <p className="text-primary-foreground/60 text-sm">{t("og.footerTagline")}</p>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="flex items-center gap-2 text-primary-foreground/60 hover:text-accent transition-colors text-sm"
              >
                <ArrowRight className="h-3 w-3" /> {t("og.backToGroupShort")}
              </button>
            </div>
          </div>
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="max-w-7xl mx-auto px-8 md:px-16 py-5 flex flex-col md:flex-row items-center justify-between gap-4">
          <span className="text-primary-foreground/40 text-xs">{t("og.rights")}</span>
