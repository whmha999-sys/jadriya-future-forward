  ...
  return (
    <div className="min-h-screen" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <section className="bg-card py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-8 md:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="section-label text-accent mb-4">{t("og.whatWeOffer")}</p>
      ...
      <section className="bg-[hsl(var(--navy-deep))] py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-8 md:px-16">
          <p className="section-label text-accent mb-4">{t("og.keyFeatures")}</p>
      ...
      <section className="bg-background py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-8 md:px-16">
          ...
          <h2 className="section-heading mb-12">{t("og.relatedProjects")}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              { img: case1, tag: t("og.casePipeline"), title: t("og.case1Title"), loc: t("og.case1Loc"), desc: t("og.case1Desc") },
              { img: case2, tag: t("og.caseRefinery"), title: t("og.case2Title"), loc: t("og.case2Loc"), desc: t("og.case2Desc") },
            ].map((c, i) => (
          ...
          <div className="mt-8 text-center">
            <button
              onClick={() => navigateWithTransition("/oil-gas")}
            ...
            >
              {t("og.viewAllCases")} <ArrowRight className={`h-4 w-4 ${isRTL ? "rotate-180" : ""}`} />
            </button>
          </div>
        </div>
      </section>
...
export default OilGasServiceSubPage;
